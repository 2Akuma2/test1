...
try 
{
  ...
  const test5replacee = spawnSync('sudo', [`sed -i s|'jdkhome="jre"'|'jdkhome="/opt/hostedtoolcache/Java_Adopt_jdk/13.0.2-8.1/x64"'| ${process.env.HOME}/work/test1/ao/addendum/assemblydesigner/buildresources/ADITOdesigner.conf`], {shell: true, stdio: 'inherit'});
