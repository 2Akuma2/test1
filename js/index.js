...
try 
{
  ...
  const test5replaceee = spawnSync('sudo', [`sed -i 's/'jdkhome="jre"'/'jdkhome="a\/b"'/' ${process.env.HOME}/work/test1/ao/addendum/assemblydesigner/buildresources/ADITOdesigner.conf`], {shell: true, stdio: 'inherit'});
