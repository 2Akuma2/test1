...
databinder = require('databinder').DataBinder;
ServerContext = require('servercontext').ServerContext;
rc = new ServerContext('javascript');
qf.setRCProvider(function(){new ServerContext("javascript")});
