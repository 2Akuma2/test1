...
rem  ###########################################################################
rem  Wrapper script for calling the TestLinkIntegrator Jython class of QF-Test #
...
set TESTLINKINTEGRATORDIR=%QFTDIR%\ext\testlink\export
...
set TESTLINKINTEGRATOR=%TESTLINKINTEGRATORDIR%\TestLinkDBIntegrator.py
